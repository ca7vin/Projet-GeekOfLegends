    ...
    enigme = () => {
        ...
        switch (enigmeCase) {
            case 1:
                ...
                break;
            case 2:
                let enigme = prompt("Quelle est la couleur du cheval blanc de Napoléon ?")
                let answ = "blanc"
                let nbTry = 1
                while (nbTry < 3 && answ != enigme) {
                    enigme = prompt(`Vous vous êtes trompés pour l'essai ${nbTry}. Retentez !`)
                ...
                break;
            case 3:
                let enigme = prompt("Mon 1er est une voiture anglaise, mon 2nd est chaud comme un anglais et mon tout est un légume. Qui suis-je")
                let answ = "carotte"
                let nbTry = 1
                while (nbTry < 3 && answ != enigme) {
                    enigme = prompt(`Vous vous êtes trompés pour l'essai ${nbTry}. Retentez !`)
